...
const Post = ({ post }) => {
  ...
  // ✅ Important: Sync state when post changes
  useEffect(() => {
    setLiked(likesArray.includes(user?._id));
    setPostLike(likesArray.length);
  ...
  return (
    <div className="my-8 w-full max-w-sm mx-auto border p-3 rounded-lg">
      {/* HEADER */}
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Avatar>
      ...
      <div className="flex items-center justify-between mt-2">
        <input
          ...
          value={text}
          onChange={changeEventHandler}
          className="outline-none text-sm w-full border p-1"
        />
        {text && (
